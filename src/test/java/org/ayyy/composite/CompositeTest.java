...
import org.ayyy.base.exhibition.composite.ExhibitionItem;
...
public class CompositeTest {
    ...
    void test(){
        ...
        // 创建展品
        ExhibitionComponent item1 = new ExhibitionItem(" 元青花四爱图梅瓶");
        ExhibitionComponent item2 = new ExhibitionItem(" 景德镇窑青花人物纹玉壶春瓶");
        ExhibitionComponent item3 = new ExhibitionItem(" 唐三彩骆驼");
        ExhibitionComponent item4 = new ExhibitionItem(" 唐三彩女立俑");
        ExhibitionComponent item5 = new ExhibitionItem(" 敦煌飞天");
        ExhibitionComponent item6 = new ExhibitionItem(" 快雪时晴帖");
        ExhibitionComponent item7 = new ExhibitionItem(" 石渠宝笈");
